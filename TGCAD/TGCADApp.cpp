...
BEGIN_OBJECT_MAP(ObjectMap)
	OBJECT_ENTRY(CLSID_TGAddIn, TGCAD)
END_OBJECT_MAP()
...
TGCAD* TGCADApp::GetTGAddin()
{ 
	return m_pTGAddin;
}

void TGCADApp::SetTGAddin(TGCAD* pAddin)
{ 
	m_pTGAddin = pAddin;
}

ApplicationPtr TGCADApp::GetApplication()
{
...
#include "comcat.h"
/*
* The function get executed by regasm.exe when registering your addin
*/
STDAPI DllRegisterServer(void)
{
	...
	EnvironmentCategories[0] = CATID_TGAll;
	...
	RegisterSEAddIn( CLSID_TGAddIn, bAutoConnect, lcid, pszDescription, pszSummary, pszHelpFilename, IntroContext, NULL,
...
/*
* The function get executed by regasm.exe when unregistering your addin
*/
STDAPI DllUnregisterServer(void)
{
	...
	EnvironmentCategories[0] = CATID_TGPart;

	ULONG cPropertySets = 0;

	UnRegisterSEAddIn( CLSID_TGAddIn, cReqCategories, NULL, cEnvironmentCategories, EnvironmentCategories, cPropertySets, NULL );
