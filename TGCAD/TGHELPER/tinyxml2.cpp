...
bool XMLUtil::ToBool( const char* str, bool* value )
{
    ...
    static const char* TRUE1[] = { "true", "True", "TRUE", 0 };
    static const char* FALSE1[] = { "false", "False", "FALSE", 0 };

    for (int i = 0; TRUE1[i]; ++i) {
        if (StringEqual(str, TRUE1[i])) {
            *value = true;
            return true;
        }
    }
    for (int i = 0; FALSE1[i]; ++i) {
        if (StringEqual(str, FALSE1[i])) {
            *value = false;
            return true;
        }
    }
