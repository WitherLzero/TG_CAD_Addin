#include "stdafx.h"
#include "TGUserCmdPopup.h"
#include "../TGHelper/util.h"
#include "../resource.h"



TGUserCmdPopup::TGUserCmdPopup()
{
}
...
HRESULT TGUserCmdPopup::Activate()
{
...
HRESULT TGUserCmdPopup::MouseMove(short sButton, short sShift, double dX, double dY, double dZ, LPDISPATCH pWindowDispatch, long lKeyPointType, LPDISPATCH pGraphicDispatch)
{
	HRESULT hr = NOERROR;
	return hr;
}

HRESULT TGUserCmdPopup::MouseDrag(short sButton, short sShift, double dX, double dY, double dZ, LPDISPATCH pWindowDispatch, short DragState, long lKeyPointType, LPDISPATCH pGraphicDispatch)
{
	HRESULT hr = NOERROR;
	return hr;
}

HRESULT TGUserCmdPopup::Filter(LPDISPATCH pGraphicDispatch, VARIANT_BOOL* vbValid)
{
	HRESULT hr = NOERROR;
	return hr;
}

HRESULT TGUserCmdPopup::KeyDown(short* KeyCode, short Shift)
{
	HRESULT hr = NOERROR;
	if (0xd == *KeyCode)
	{
