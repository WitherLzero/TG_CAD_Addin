...
STDMETHODIMP_(HRESULT __stdcall) ParamDriveCmd::MouseClick(short sButton, short sShift, double dX, double dY, double dZ, LPDISPATCH pWindowDispatch, long lKeyPointType, LPDISPATCH pGraphicDispatch)
{
	HRESULT hr = NOERROR;
...
STDMETHODIMP_(HRESULT __stdcall) ParamDriveCmd::MouseMove(short sButton, short sShift, double dX, double dY, double dZ, LPDISPATCH pWindowDispatch, long lKeyPointType, LPDISPATCH pGraphicDispatch)
{
	HRESULT hr = NOERROR;
	return hr;
}

STDMETHODIMP_(HRESULT __stdcall) ParamDriveCmd::MouseDrag(short sButton, short sShift, double dX, double dY, double dZ, LPDISPATCH pWindowDispatch, short DragState, long lKeyPointType, LPDISPATCH pGraphicDispatch)
{
	HRESULT hr = NOERROR;
	return hr;
}

STDMETHODIMP_(HRESULT __stdcall) ParamDriveCmd::Filter(LPDISPATCH pGraphicDispatch, VARIANT_BOOL* vbValid)
{
	HRESULT hr = NOERROR;
	return hr;
}

STDMETHODIMP_(HRESULT __stdcall) ParamDriveCmd::KeyDown(short* KeyCode, short Shift)
{
	HRESULT hr = NOERROR;
	if (0xd == *KeyCode)
	{
