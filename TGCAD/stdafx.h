...
#import <tgframewrk.tlb> exclude ("UINT_PTR", "LONG_PTR") rename ("GetOpenFileName", "SEGetOpenFileName")
#import <tgfwksupp.tlb>

#import <tggeometry.tlb>
#import <tgpart.tlb>
#import <tgassembly.tlb>
#import <tgdraft.tlb>

// clang-format on
using namespace TGFramework;
using namespace TGAssembly;
using namespace TGFrameworkSupport;
...
HWND WINAPI AddinHtmlHelpA(HWND hwndCaller, LPCSTR pszFile, UINT uCommand,
                           DWORD_PTR dwData);

HWND WINAPI AddinHtmlHelpW(HWND hwndCaller, LPCWSTR pszFile, UINT uCommand,
                           DWORD_PTR dwData);
#ifdef UNICODE
...
STDAPI RegisterSEAddIn(
    ...
    ULONG cEnvironmentCategories,  // Number of SE environments addin supplies
                                   // commands for
